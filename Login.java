...
public class Login extends JFrame {
	...
	public Login() {
		...
		jlblinfo.setFont(new Font("맑은고딕",Font.BOLD,20)); //
		...
		ImageIcon icon = new ImageIcon("E:/dev/workspace/javase_prj/src/project/as.jpg");//이미지객체 
		//JPanel에 추가
//		JPanel jp=new JPanel() {
//			public void paintComponent(Graphics g) {//그리는 함수
//				g.drawImage(icon.getImage(), 100,250,200,50,null);//background를 그려줌		
//				setOpaque(false); //투명화
