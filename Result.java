...
public class Result extends JDialog {
	...
	public Result(SelectMenu main,SelectmenuEvt smenu,LogVO lv) {
		...
		jtfmaxKey.setText(lv.getMostFrequentKey()+" / "+lv.getMostFrequentKeyV()+"개");
		...
		jtfserviceSucess.setText(lv.getCode200()+"개("+Math.round(((double)lv.getCode200()/(double)smenu.getCntLine()*100.0))+"%)");
		...
		jtfserviceSucess1.setText(lv.getCode404()+"개("+Math.round(((double)lv.getCode404()/(double)smenu.getCntLine()*100.0))+"%)");
		...
		jtfrequestTime.setText(lv.getMaxHourValue()+"시");
		...
		jtfrequest403.setText(lv.getCode403()+"개("+Math.round(((double)lv.getCode403()/(double)smenu.getCntLine()*100.0))+"%)");
		...
		jtfrequest500.setText(lv.getCode500()+"개("+Math.round(((double)lv.getCode500()/(double)smenu.getCntLine()*100.0))+"%)");
